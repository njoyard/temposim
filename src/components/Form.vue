...
<template>
  ...
  <p class="my-4">
    Spécifiez ci-dessous la ou les plages d'heures creuses. Si vous n'avez pas
    souscrit l'option Heures Creuses, il n'est malheureusement pas possible de
    savoir quelles plages vous auriez (le gestionnaire de réseau vous attribe
    les plages d'heures creuses en fonction des besoins du réseau, et il n'est
    pas possible de les choisir ni de les modifier).
  </p>
